...
import adjustMealPlan from '@wasp/actions/adjustMealPlan';
import getPersonalData from '@wasp/queries/getPersonalData';
import getMealPlan from '@wasp/queries/getMealPlan';
import getFoodItems from '@wasp/queries/getFoodItems';
